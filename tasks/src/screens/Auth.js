...
import { StyleSheet, Text, View,
            ImageBackground, TouchableOpacity, Alert, AsyncStorage } from 'react-native';
...
export default class Auth extends Component {
  ...
  render() {
    ...
    //validation.push(this.state.password && this.state.password.length > 0)
    ...
    return (
        <ImageBackground source={backgroundImage}
            ...
            <View style={styles.formContainer}>
                ...
                {this.state.stageNew &&
                    <AuthInput icon='asterik' secureTextEntry={true} placeholder='Confirmar senha' style={styles.input} 
